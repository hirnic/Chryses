...
allButtons = { # Main Menu Buttons
    ...
    "purchaseButton" : tk.Button(buildingsOverviewFrame, text="Purchase")
}
...
def examineBuilding(event, buildingName):
    ...
    price = planet.getPrice(1, SDB.MasterBuildingsList[buildingName])
    timeNeeded = planet.getTime(1, SDB.MasterBuildingsList[buildingName], universeSpeed)
    ...
    allButtons["purchaseButton"].place(relx = 0.75, rely = 0.875, relwidth = 0.225, relheight = 0.1)
